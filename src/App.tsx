...
function App() {
  ...
  const [createEditError, setCreateEditError] = useState<ErrorResponseDTO | null>(null);
...
const handleDelete = (id: number) => {
  const shouldDelete = window.confirm("Möchten Sie diesen Eintrag wirklich löschen?");
